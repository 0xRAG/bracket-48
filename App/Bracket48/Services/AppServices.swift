...
protocol ResultsServicing: Sendable {
...
struct AppServices: Sendable {
    ...
    let results: any ResultsServicing
    ...
    static let unconfigured = AppServices(
        ...
        results: UnconfiguredResultsService()
    )
    ...
    static func live(configuration: AppConfiguration = .main) throws -> AppServices {
        ...
        return AppServices(
            ...
            results: SupabaseResultsService(client: client)
        )
    }
}
...
private struct UnconfiguredResultsService: ResultsServicing {
    func listTournamentMatches() async throws -> [BackendTournamentMatch] {
        []
    }
