...
- Age Assurance: No.
- User-Generated Content: Yes, because users create display names, group names, and bracket picks visible to group members.
...
- Kids Category: Not Applicable.
- Override to Higher Age Rating: Not Applicable.

## Expected Rating

Likely 4+ or equivalent, but App Store Connect calculates the final global and region-specific ratings from the questionnaire.
